...
using Aura.Framework.Connectivity.Client.Connection;
using Aura.Framework.Connectivity.Client.Connection.Packets;
using System;
using System.Diagnostics;
using System.Threading.Tasks;

namespace Aura.Framework.Connectivity.Client
{
    /// <summary>
