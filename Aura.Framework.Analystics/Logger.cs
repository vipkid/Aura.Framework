...
namespace Aura.Framework.Analystics
{
    ...
    public class Logger : ILogger, IDisposable
    {
        ...
        /// <summary>
        /// An event that occures when the <see cref="Logger"/> class instance logs an error line to the log file.
        /// </summary>
        public event EventHandler<LoggerWritenEventArgs> ErrorWriten;
        ...
        public string Write(LoggerType type, object line)
        {
            if (type == LoggerType.Error)
                OnErrorWriten(new LoggerWritenEventArgs(line.ToString()));
        ...
        /// <summary>
        /// Fires the <see cref="ErrorWriten"/> event.
        /// </summary>
        protected virtual LoggerWritenEventArgs OnErrorWriten(LoggerWritenEventArgs e)
        {
            ErrorWriten?.Invoke(this, e);
            return e;
        }
